...
- ✅ v0.7.3 visual scale and monster pass: Puny combat bodies render 30% larger, equipment anchors scale from body size with separate bow/staff/melee placement, and all twelve monster silhouettes use Clint Bellanger's Kenney-compatible CC0 Tiny Creatures species tiles (including alternating bat wing frames).
- ✅ v0.7.5 attached weapon grips: body and equipment share the same idle/walk frame, main-hand and offhand anchors follow each frame's actual hand pixels, facing mirrors body and gear together, and axe/hammer tiles rotate around the lower handle instead of their image center.
- ✅ v0.7.6 weapon-family poses: all attacks keep the measured hand anchor as their pivot; swords, axes and hammers use distinct anticipation/contact/recovery arcs; bows draw a visible string and arrow; staves focus and pulse on release. Dungeon and touch-scale visual acceptance remain open gates.
- ✅ v0.7.7 contact-timed feedback: melee effects wait for the swing contact frame; arrows/spells spawn after anticipation and land after travel; target recoil, hit flash, damage text, critical feedback and audio are synchronized to release or impact rather than attack start.
- ✅ v0.7.8 directional carrying: attack vectors now angle carried weapons toward north/south targets while retaining stable left/right body facing; northward weapons and offhands pass behind the pawn, while southward and idle equipment renders in front without changing hand anchors.
- ✅ v0.7.9 visible equipment identity: each current weapon base carries a distinct style/scale/material cue, rarity color is integrated into the weapon, and a hand-over-grip cap makes attachment explicit while preserving directional depth ordering.
- ✅ v0.7.10 two-handed carrying: bow support hands follow the moving string notch, axe/hammer hands brace the lower handle, casting staves gain a focus grip, all support points inherit weapon transforms/depth, and occupied offhand slots prevent false extra limbs.
- ✅ v0.7.11 weapon-bound attack emphasis: grip-centered melee/heavy arcs, bow release streaks and staff focus rings peak only during their family-specific strike windows, inherit directional/depth transforms and use equipped rarity accents.
- ✅ v0.7.12 combat barks: compact family-specific speech bubbles appear at weapon release/contact in town and dungeons, with delayed-lifetime correctness, per-pawn cooldowns, a three-bubble crowd cap and critical override for large battles.
- ✅ v0.7.13 town self-defense: residents immediately interrupt sleep, work and leisure when directly threatened; healthy nearby allies rally against intruders already inside town; emergency defense tolerates low vigor/satiety without forcing critically wounded pawns into suicidal fights; frontier monsters do not wake the whole village.
