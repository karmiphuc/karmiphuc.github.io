...
- ✅ **Persistent weapon carrying baseline** — equipped swords, bows, staves, axes and hammers are now visible beside pawns in town and dungeons, follow attack motion, and use role-aware auto-equip preferences. Unarmed jobs show a readable training weapon until they acquire equipment. Next: rendered verification, visible armor/shields and a more deliberate gifting/equipment loop.
